...
const Footer = () => {
  ...
  const getButtonClass = (id) => {
    const isActive =
      activeTab === id || (id === "projects" && activeTab === "experience");
    return (
  ...
  return (
    <>
      <main>
        {/* CTA Section */}
        <section
          className="py-16 px-4 md:py-24 md:px-20 text-center"
          id="contact"
        >
          <div className="bg-surface-container-high rounded-2xl md:rounded-3xl p-8 md:p-16 border border-primary/10 relative overflow-hidden">
            ...
            <div className="relative z-10 space-y-6 md:space-y-8">
              <h2 className="text-[clamp(1.8rem,6vw,3rem)] font-headline font-extrabold uppercase tracking-tight">
                Ready to Initialize?
              </h2>
              ...
              <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-4">
                <a
                  className="px-8 py-4 bg-primary text-on-primary font-bold rounded shadow-[0_10px_30px_rgba(99,102,241,0.2)] hover:scale-105 transition-transform flex items-center justify-center gap-3 w-full sm:w-auto"
                  href="mailto:gowrishankarkrce@gmail.com"
                >
                ...
                <a
                  className="px-8 py-4 border border-outline hover:bg-white/5 transition-colors font-mono uppercase tracking-widest text-sm flex items-center justify-center gap-3 w-full sm:w-auto"
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 bg-slate-900/80 backdrop-blur-xl border-t border-white/5 z-50">
        <div className="flex justify-around items-center p-4">
          <button
            className={getButtonClass("init")}
            onClick={(e) => scrollToSection(e, "init")}
          >
